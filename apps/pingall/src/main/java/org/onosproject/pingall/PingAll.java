 ...
 */
package org.onosproject.pingall;
...
/**
 * Sample application that allows all ICMP Traffic
 */
@Component(immediate = true)
public class PingAll {

    private static Logger log = LoggerFactory.getLogger(PingAll.class);
    ...
    private static final String MSG_PING_BLOCKED =
            "Err... NO!" +
                    "ICMP from {} to {} is blocked on {} for 10 seconds";

    private static final int PRIORITY = 128;
//    private static final int DROP_PRIORITY = 129;
    private static final int DROP_PRIORITY = 60000;
    ...
    private final Timer timer = new Timer("pingall-sweeper");

    @Activate
    public void activate() {
        appId = coreService.registerApplication("org.onosproject.pingall",
    ...
    private void processPing(PacketContext context, Ethernet eth) {
        ...
        log.info(MSG_PING_BLOCKED, src, dst, deviceId);
    ...
    private void banPings(DeviceId deviceId, MacAddress src, MacAddress dst)
    {
        ...
        // Install the flow rule to specific device.
