 ...
 */
package org.onosproject.noping;
...
/**
 * Sample application that blocks all ICMP Traffic
 */
@Component(immediate = true)
public class NoPing {

    private static Logger log = LoggerFactory.getLogger(NoPing.class);
...
//    private static final int DROP_PRIORITY = 129;
    ...
    private final Timer timer = new Timer("noping-sweeper");
